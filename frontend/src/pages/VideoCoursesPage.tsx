...
const VideoCoursesPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const { data } = await axios.get<Course[]>('https://carrerpath-m48v.onrender.com/api/courses');
        setCourses(data);
        setLoading(false);
      } catch (err) {
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Price Badge */}
                <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-medium font-inter ${course.price === 0
              ...
              <div className="p-6">
                ...
                <Link
                  ...
                  className={`block text-center py-3 px-4 rounded-lg font-medium transition-colors duration-200 font-inter ${course.price === 0
