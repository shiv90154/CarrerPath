...
const seedLiveTests = async () => {
    try {
        ...
        if (!instructor) {
            console.log('⚠️ No admin user found. Creating default instructor...');
            const bcrypt = require('bcryptjs');
            const salt = await bcrypt.genSalt(10);
            const hashedPassword = await bcrypt.hash('admin123', salt);

            instructor = new User({
                name: 'Live Test Instructor',
                email: 'instructor@careerpathway.com',
                phone: '9999999998',
        ...
        const questions1 = [
            ...
            {
                questionText: 'What is the current repo rate set by RBI?',
                options: [
                    { text: '6.50%', isCorrect: true },
                    { text: '6.25%', isCorrect: false },
                    { text: '6.75%', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Western Ghats', isCorrect: true },
                    { text: 'Gangetic Plains', isCorrect: false },
        ...
        console.log('   1. UPSC Prelims Mock Test (120 min, 5 questions)');
        console.log('   2. SSC CGL General Awareness (30 min, 3 questions)');
