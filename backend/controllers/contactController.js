...
const sendContactMessage = asyncHandler(async (req, res) => {
        ...
        <div style="padding: 30px; background-color: #f9f9f9;">
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; text-align: center;">
            <p style="color: #999; font-size: 12px; margin: 0;">
              This message was sent from the Career Pathway Institute contact form.<br>
  ...
  const userMailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: `Thank you for contacting Career Pathway Institute - ${subject}`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #0B1F33 0%, #1E3A8A 100%); padding: 20px; text-align: center;">
          <h1 style="color: white; margin: 0;">Career Pathway Institute</h1>
        ...
        <div style="padding: 30px; background-color: #f9f9f9;">
          ...
          <p style="color: #666; font-size: 16px; line-height: 1.6;">
            Thank you for reaching out to Career Pathway Institute. We have received your message regarding 
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://carrer-path-8m3c.vercel.app" 
               style="background: #0B1F33; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: bold;">
              Visit Our Website
            </a>
          </div>
          ...
          <div style="background: #fff3e0; padding: 15px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul style="color: #666; line-height: 1.6; padding-left: 20px;">
              <li><a href="https://carrer-path-8m3c.vercel.app/courses" style="color: #0B1F33;">Browse our courses</a></li>
              <li><a href="https://carrer-path-8m3c.vercel.app/test-series" style="color: #0B1F33;">Practice with test series</a></li>
              <li><a href="https://carrer-path-8m3c.vercel.app/e-books" style="color: #0B1F33;">Download e-books</a></li>
              <li><a href="https://carrer-path-8m3c.vercel.app/current-affairs" style="color: #0B1F33;">Stay updated with current affairs</a></li>
            </ul>
          </div>
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
            <p style="color: #999; font-size: 12px; text-align: center; margin: 0;">
              ...
              For immediate assistance, contact us at <a href="mailto:Shiva90154@gmail.com" style="color: #0B1F33;">Shiva90154@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
...
const getContactInfo = asyncHandler(async (req, res) => {
  const contactInfo = {
    ...
    email: ['info@careerpathway.in', 'Shiva90154@gmail.com'],
    hours: {
    ...
    social: {
      facebook: 'https://facebook.com/careerpathway',
      twitter: 'https://twitter.com/careerpathway',
      instagram: 'https://instagram.com/careerpathway',
      linkedin: 'https://linkedin.com/company/careerpathway',
      youtube: 'https://youtube.com/careerpathway'
    },
    map: {
      latitude: 28.613939,
      longitude: 77.209027,
